...
import { ApiChatMessage, ApiChatSession, SavedApiChatSession } from '.'
import {
  PROMPT_CHAT,
  PROMPT_CHAT_REFINE,
...
const convertDefaultChatSessionToSaved = (session: ApiChatSession, file_ids: string[]): SavedApiChatSession => {
  return {
    id: session.id,
...
export const apiUtils = {
  ...
  generateFromFiles,
  generateFromManyQuery,
  convertDefaultChatSessionToSaved
}
